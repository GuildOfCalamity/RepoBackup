...
/// <summary>
/// These APIs are in the approved list for UWP/WinUI apps.
/// </summary>
public class NativeMethods
{
    ...
    [DllImport("kernel32.dll", SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetSystemTimes(out long lpIdleTime, out long lpKernelTime, out long lpUserTime); // CPU times
    ...
    #region [Windows Property System]
    public enum PLACEHOLDER_STATES : uint
    {
       NONE = 0,                               // None of the other states apply at this time.
       MARKED_FOR_OFFLINE_AVAILABILITY = 0x01, // May already be or eventually will be available offline.
       FULL_PRIMARY_STREAM_AVAILABLE = 0x02,   // The primary stream has been made fully available.
       CREATE_FILE_ACCESSIBLE = 0x04,          // The file is accessible through a call to the CreateFile function, without requesting the opening of reparse points.
       CLOUDFILE_PLACEHOLDER = 0x08,
       DEFAULT,
       ALL                                     // A bitmask value for all valid PLACEHOLDER_STATES flags.
    }

    public enum ZONE_ID : uint
    {
        LocalMachine = 0,
        LocalIntranet = 1,
        TrustedSites = 2,
    ...
    /// <summary>
    /// For use in removing "Zone.Identifier" streams.
    /// </summary>
