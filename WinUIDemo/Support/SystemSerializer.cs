...
public class SystemSerializer : IObjectSerializer
{
    ...
    public T Deserialize<T>(object value)
    {
        ...
        static T ThrowNotSupportedException() => throw new NotSupportedException($"This serializer can only handle primitive types and strings. Please implement your own {nameof(IObjectSerializer)} for more complex scenarios.");
    }
